...
$quiz_questions = [
    [
        ...
        'correct_answer' => 'A',
        'explanation' => 'Hola means "Hello" in Spanish and is used as a greeting.'
    ],
    [
    ...
    [
        'question' => 'Which number is "cinco" in Spanish?',
        'options' => [
            'A' => '3',
            'B' => '4',
            'C' => '5',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Debug output
        error_log("Spanish Quiz - Subject/Course Query Results: " . print_r($subject_row, true));
        ...
        if ($subject_id && $course_id) {
            ...
            if (!$existing_enrollment) {
                ...
                if (!$stmt->execute()) {
                    ...
                    error_log("Successfully enrolled in Spanish course. User: $user_id");
                }
            }
            ...
            if (!$stmt->execute()) {
                ...
                error_log("Successfully recorded Spanish quiz attempt. User: $user_id, Score: $percentage%");
            }
        } else {
            error_log("Subject/Course ID not found for Spanish quiz - Please check subjects and courses tables");
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>Spanish Basics Quiz | RevvIt</title>
...
<body class="bg-orange-50 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        ...
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-center mb-8">Spanish Basics Quiz</h1>
