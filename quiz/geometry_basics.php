...
$quiz_questions = [
    [
        ...
        'correct_answer' => 'A',
        'explanation' => 'The area of a triangle is calculated by multiplying the base by the height and dividing by 2.'
    ],
    [
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Debug output
        error_log("Geometry Quiz - Subject/Course Query Results: " . print_r($subject_row, true));
        ...
        if ($subject_id && $course_id) {
            ...
            if (!$existing_enrollment) {
                ...
                if (!$stmt->execute()) {
                    ...
                    error_log("Successfully enrolled in Geometry course. User: $user_id");
                }
            }
            ...
            if (!$stmt->execute()) {
                ...
                error_log("Successfully recorded Geometry quiz attempt. User: $user_id, Score: $percentage%");
            }
        } else {
            error_log("Subject/Course ID not found for Geometry quiz - Please check subjects and courses tables");
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>Geometry Basics Quiz | RevvIt</title>
...
<body class="bg-orange-50 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        ...
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-center mb-8">Geometry Basics Quiz</h1>
