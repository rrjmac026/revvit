...
$quiz_questions = [
    [
        ...
        'correct_answer' => 'A',
        'explanation' => 'Bonjour means "Hello" in French and is used as a formal greeting.'
    ],
    [
        'question' => 'Which number is "trois" in French?',
        'options' => [
            'A' => '2',
            'B' => '3',
            'C' => '4',
        ...
        'correct_answer' => 'B',
        'explanation' => 'Trois is the French word for the number 3.'
    ],
    [
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Debug output
        error_log("French Quiz - Subject/Course Query Results: " . print_r($subject_row, true));
        ...
        if ($subject_id && $course_id) {
            ...
            if (!$existing_enrollment) {
                ...
                if (!$stmt->execute()) {
                    ...
                    error_log("Successfully enrolled in French course. User: $user_id");
                }
            }
            ...
            if (!$stmt->execute()) {
                ...
                error_log("Successfully recorded French quiz attempt. User: $user_id, Score: $percentage%");
            }
        } else {
            error_log("Subject/Course ID not found for French quiz - Please check subjects and courses tables");
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>French Basics Quiz | RevvIt</title>
...
<body class="bg-orange-50 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        ...
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-center mb-8">French Basics Quiz</h1>
