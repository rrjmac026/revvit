...
$quiz_questions = [
    ...
    [
        'question' => 'In a right triangle, which side is opposite to the 90-degree angle?',
        'options' => [
            'A' => 'Adjacent',
            'B' => 'Hypotenuse',
            'C' => 'Base',
        ...
        'correct_answer' => 'B',
        'explanation' => 'The hypotenuse is always opposite to the 90-degree angle in a right triangle.'
    ],
    [
        'question' => 'What is the tangent of an angle?',
        'options' => [
            'A' => 'sine ÷ cosine',
            'B' => 'cosine ÷ sine',
            'C' => 'sine × cosine',
        ...
        'correct_answer' => 'A',
        'explanation' => 'The tangent of an angle is equal to sine divided by cosine (tan = sin/cos).'
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $subject_query = $conn->prepare("
            ...
            WHERE s.name LIKE '%Trigonometry%' OR s.name LIKE '%Math%'
        ");
        ...
        // Debug output
        error_log("Trigonometry Quiz - Subject/Course Query Results: " . print_r($subject_row, true));
        ...
        if ($subject_id && $course_id) {
            ...
            if (!$existing_enrollment) {
                ...
                if (!$stmt->execute()) {
                    ...
                    error_log("Successfully enrolled in Trigonometry course. User: $user_id");
                }
            }
            ...
            if (!$stmt->execute()) {
                ...
                error_log("Successfully recorded Trigonometry quiz attempt. User: $user_id, Score: $percentage%");
            }
        } else {
            error_log("Subject/Course ID not found for Trigonometry quiz - Please check subjects and courses tables");
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>Trigonometry Quiz | RevvIt</title>
...
<body class="bg-orange-50 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        ...
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-center mb-8">Trigonometry Quiz</h1>
