...
$quiz_questions = [
    [
        ...
        'options' => [
            'A' => 'A set of rules that governs data communication',
            'B' => 'A type of network cable',
            'C' => 'A network security device',
            'D' => 'A type of computer'
        ],
        'correct_answer' => 'A',
        'explanation' => 'A network protocol is a set of established rules that specify how data is transmitted between different devices in the same network.'
    ],
    [
        ...
        'correct_answer' => 'C',
        'explanation' => 'HTTPS (Hypertext Transfer Protocol Secure) is used for secure web browsing, encrypting the data transferred between the client and server.'
    ],
    [
        ...
        'correct_answer' => 'B',
        'explanation' => 'A router is a networking device that forwards data packets between computer networks, directing traffic between them.'
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Debug output
        error_log("Networking Quiz - Subject/Course Query Results: " . print_r($subject_row, true));
        ...
        if ($subject_id && $course_id) {
            ...
            if (!$existing_enrollment) {
                ...
                if (!$stmt->execute()) {
                    ...
                    error_log("Successfully enrolled in Networking course. User: $user_id");
                }
            }
            ...
            if (!$stmt->execute()) {
                ...
                error_log("Successfully recorded Networking quiz attempt. User: $user_id, Score: $percentage%");
            }
        } else {
            error_log("Subject/Course ID not found for Networking quiz - Please check subjects and courses tables");
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>Networking Basics Quiz | RevvIt</title>
...
<body class="bg-orange-50 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        ...
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-center mb-8">Networking Basics Quiz</h1>
