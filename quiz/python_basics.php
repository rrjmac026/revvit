...
$quiz_questions = [
    ...
    [
        ...
        'correct_answer' => 'C',
        'explanation' => 'Python allows variables to start with an underscore, but not with a number'
    ],
    [
        'question' => 'What does the len() function do?',
        'options' => [
            'A' => 'Calculates mathematical length',
            'B' => 'Returns the number of items in an object',
            'C' => 'Creates a new list',
            'D' => 'Converts a string to lowercase'
        ],
        'correct_answer' => 'B',
        'explanation' => 'len() returns the number of items in a list, string, dictionary, or other collection'
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Debug output
        error_log("Python Quiz - Subject/Course Query Results: " . print_r($subject_row, true));
        ...
        if ($subject_id && $course_id) {
            ...
            if (!$existing_enrollment) {
                ...
                if (!$stmt->execute()) {
                    ...
                    error_log("Successfully enrolled in Python course. User: $user_id");
                }
            }
            ...
            if (!$stmt->execute()) {
                ...
                error_log("Successfully recorded Python quiz attempt. User: $user_id, Score: $percentage%");
            }
        } else {
            error_log("Subject/Course ID not found for Python quiz - Please check subjects and courses tables");
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>Python Basics Quiz | RevvIt</title>
...
<body class="bg-orange-50 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        ...
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-center mb-8">Python Basics Quiz</h1>
