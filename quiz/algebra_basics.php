...
$quiz_questions = [
    [
        ...
        'correct_answer' => 'A',
        'explanation' => 'Solve for x: 2x + 5 = 13, subtract 5 from both sides, then divide by 2'
    ],
    [
    ...
    [
        ...
        'correct_answer' => 'C',
        'explanation' => 'Add 7 to both sides, then divide by 3: 3x = 21, x = 7'
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Debug output
        error_log("Algebra Quiz - Subject/Course Query Results: " . print_r($subject_row, true));
        ...
        if ($subject_id && $course_id) {
            ...
            if (!$existing_enrollment) {
                ...
                if (!$stmt->execute()) {
                    ...
                    error_log("Successfully enrolled in Algebra course. User: $user_id");
                }
            }
            ...
            if (!$stmt->execute()) {
                ...
                error_log("Successfully recorded Algebra quiz attempt. User: $user_id, Score: $percentage%");
            }
        } else {
            error_log("Subject/Course ID not found for Algebra quiz - Please check subjects and courses tables");
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>Algebra Basics Quiz | RevvIt</title>
...
<body class="bg-orange-50 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <h1 class="text-3xl font-bold text-center mb-8">Algebra Basics Quiz</h1>
